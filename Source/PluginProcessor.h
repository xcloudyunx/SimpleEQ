...
void update(ChainType& chain, const CoefficientType& cutCoefficents) {
    updateCoefficients(chain.template get<Index>().coefficients, cutCoefficents[Index]);
    chain.template setBypassed<Index>(false);
}

template<typename ChainType, typename CoefficientType>
void updateCutFilter(ChainType& cut, const CoefficientType& cutCoefficients, const Slope& cutSlope) {
